// components/CoverHeroClient.tsx
"use client";
...
export default function CoverHeroClient() {
      ...
      >
        ...
        >
          <img
            src="/images/logo.png"
            alt="Logo"
            className="w-[80px] h-[80px] md:w-[110px] md:h-[110px] object-contain mx-auto invert sepia saturate-200 hue-rotate-45 brightness-110"
          />
        </motion.div>
        ...
        <motion.p
          ...
          className="text-sm md:text-base font-light tracking-wide mb-6 absolute bottom-36 md:bottom-48"
        >
          13 • 12 • 2025
        </motion.p>
      ...
      >
        ...
        >
          <motion.button
            ...
            className="px-2 py-1 bg-white text-black shadow-md font-lora transition-all tracking-wide rounded-xs"
          >
           Buka Undangan
          </motion.button>
        </Link>
